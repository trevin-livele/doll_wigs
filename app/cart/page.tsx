      ...
      <div className="container mx-auto px-4 py-12">
        ...
        {cart.length === 0 ? (
          <div className="text-center py-16 bg-white rounded-xl shadow-sm">
            ...
            <Link href="/" className="inline-block bg-[#e88b7d] text-white px-8 py-3 rounded-lg hover:bg-[#d67a6c] transition font-medium">
              Start Shopping
            </Link>
          </div>
        ) : (
          <div className="grid grid-cols-3 gap-8">
            ...
            <div className="col-span-2">
              <div className="bg-white rounded-xl shadow-sm overflow-hidden">
                ...
                {cart.map(item => (
                  <div key={item.id} className="grid grid-cols-12 gap-4 p-5 border-b items-center hover:bg-gray-50 transition">
            ...
            <div className="col-span-1">
              <div className="bg-white rounded-xl shadow-sm p-6 sticky top-4">
                ...
                <Link 
                  href="/checkout"
                  className="block w-full bg-[#e88b7d] text-white py-4 rounded-lg text-center font-medium hover:bg-[#d67a6c] transition mt-6 shadow-lg shadow-[#e88b7d]/25"
                >
                  Proceed to Checkout
                </Link>
